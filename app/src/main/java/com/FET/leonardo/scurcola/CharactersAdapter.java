...
public class CharactersAdapter extends RecyclerView.Adapter<CharactersAdapter.CoursesViewHolder> {
    ...
    public CharactersAdapter(ArrayList<Player> arrayCourses) {
    ...
    public CoursesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.two_line_list_item_horizontal_characters, parent, false);
    ...
    public void onBindViewHolder(CoursesViewHolder holder, int position) {
        ...
        holder.card.setText(player.getCard().name());
    }
